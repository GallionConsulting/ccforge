...
<!-- Note: {{TESTING_FEATURE_IDS}} is a placeholder substituted at runtime with comma-separated feature IDs -->
...
For each feature ID listed above, use `feature_get_by_id` to get the details:
